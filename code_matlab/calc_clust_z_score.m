...
%  given distance matrix, trace result, and expected clustering
%  calculate z-score of clustering for every selection size 1 to L
% (starting with the most important residues)
